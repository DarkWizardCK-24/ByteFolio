...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    icon: Cpu,
    skills: [
      { name: "React", icon: FaReact, gradient: "from-cyan-500/20 to-blue-500/20" },
      { name: "Flutter", icon: SiFlutter, gradient: "from-green-500/20 to-emerald-500/20" },
      { name: "Firebase", icon: SiFirebase, gradient: "from-cyan-500/20 to-teal-500/20" },
      { name: "Supabase", icon: SiSupabase, gradient: "from-blue-500/20 to-indigo-500/20" },
      { name: "Git", icon: FaGitAlt, gradient: "from-orange-500/20 to-red-500/20" },
      { name: "SQL", icon: BiLogoPostgresql, gradient: "from-green-500/20 to-emerald-500/20" },
      { name: "Django", icon: SiDjango, gradient: "from-orange-500/20 to-red-500/20" },
      { name: "FastAPI", icon: SiFastapi, gradient: "from-green-500/20 to-emerald-500/20" },
    ],
  },
  {
    title: "Platforms",
    icon: Layers,
    skills: [
      { name: "Android", icon: FaAndroid, gradient: "from-blue-500/20 to-cyan-500/20" },
  ...
  },
  {
    ...
    icon: Wrench,
    skills: [
      { name: "VsCode", icon: VscVscodeInsiders, gradient: "from-green-500/20 to-emerald-500/20" },
      { name: "Xcode", icon: SiXcode, gradient: "from-blue-500/20 to-indigo-500/20" },
      { name: "Postman", icon: SiPostman, gradient: "from-red-500/20 to-orange-500/20" },
