...
const ecosystemProjects = [
  ...
  {
    title: "Kanban Finance",
    tagline: "Smart Wealth Manager",
    description:
      "Visualize savings, investments & goals on Kanban boards with real-time Firebase sync.",
    icon: TrendingUp,
    color: "amber",
    skills: ["Next.js 14", "TypeScript", "Firebase"],
  ...
  {
    title: "Task Tango",
    tagline: "Productivity Task Manager",
    description:
      "Modern task management with REST API integration, clean responsive UI, and smart workflows.",
    icon: CheckSquare,
    color: "emerald",
    skills: ["Next.js", "REST API", "Tailwind CSS"],
  ...
  },
  {
    ...
    description:
      "Concise URL shortener with optional click tracking, custom short URLs, and MongoDB storage.",
    icon: Link2,
    color: "cyan",
    skills: ["Next.js", "MongoDB", "REST API"],
  ...
  {
    title: "Secure Spark",
    tagline: "Password Strength Analyzer",
    description:
      "Real-time password checker with entropy calculation and brute-force crack time estimation.",
    icon: ShieldCheck,
    color: "red",
  ...
  {
    title: "Pass Vault",
    tagline: "Secure Credential Manager",
    description:
      "Full CRUD credential & password storage with a clean, intuitive interface and local persistence.",
    icon: KeyRound,
    color: "orange",
    skills: ["React.js", "JavaScript", "Tailwind CSS"],
  ...
  },
  {
    ...
    description:
      "Linktree-inspired personal link hub with custom link creation and MongoDB-backed storage.",
    icon: TreePine,
    color: "teal",
    skills: ["Next.js", "MongoDB", "JavaScript"],
  ...
  },
  {
    ...
    description:
      "Sleek animated portfolio template with Framer Motion, SEO optimization, and accessible design.",
    icon: Briefcase,
    color: "pink",
    skills: ["Next.js", "Framer Motion", "JavaScript"],
